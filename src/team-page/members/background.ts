...
const getPlayerInfo = async (stringSteamIds: string[]): Promise<PlayerInfo[]> => {
...
const faceitExtractor = (faceitResponse: Response): Promise<FaceitInfo> => {
...
const findOnFaceit = async (steamId: ID): Promise<FaceitInfo> => {
    console.log(steamId);
